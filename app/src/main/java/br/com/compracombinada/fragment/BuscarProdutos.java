...
import br.com.compracombinada.adapter.ListAdapterProduto;
...
public class BuscarProdutos extends Fragment {
    ...
    public void retornoAsyncTaskCompraCombinadaProdutos(String jsonString){
        ...
        ArrayList<ArrayList> items = new Gson().fromJson(jsonString, ArrayList.class);

        for (ArrayList al:items) {

            Produto p = new Produto();
            p.setId(Integer.parseInt(al.get(0).toString().replace(".0", "")));
            p.setNome(al.get(1).toString());
            if(al.get(2) != null)
        ...
        switch (requestCode) {
            ...
            case 1:
                ...
                if (resultCode == Activity.RESULT_OK) {
                   ...
                   // Lista l = ((Cotacao)getArguments().getSerializable("cotacao")).getListaCotacao();
                   // l.setId(data.getIntExtra("listaCotacaoUsuarioId",0));
                   // ps.setLista(l);
                    listProdutos.add(ps);
